...
- 26メッシュ・543頂点・標準17種/カスタム5種Expressionへ更新。
- 左右の腕を上腕・前腕・手へ3分割し、肩・肘・手首を連鎖変形する`greet`へ更新。
- 眉、笑い線、`sleepy`を追加し、感情ごとの眉・まぶた・口元の差を強化。
- 5母音の滑らかな補間と、ローカル音声ファイル解析による口パクを追加。
- 髪・顔・アクセサリーの微小な奥行き視差を追加し、足元固定を維持。
- READMEは最新の実機GIF/MP4だけを表示し、旧Phase 1〜6動画を削除。
- 最新GIFの動き・足元固定・腕6分割・眉2分割を検査する視覚品質ゲートを追加。
